...
def set_args():
    ...
    *************************************************************************
    '''
    parser.add_argument("-read_train_num", type=int, default=80000, help='读取训练集大小')
    parser.add_argument("-read_val_num", type=int, default=20000, help="读取的验证集大小")
    ...
    *************************************************************************
    ...
    parser.add_argument("-generator_batch", type=int, default=32, help="每次生成多少个词，消耗内存")
