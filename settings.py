...
'''
    *************************************************************************
    Porto原来有轨迹170万条 (1657341)，经过拆分+下采样/噪声偏移，训练集有约4800万轨迹，测试1200万轨迹,读取耗时一小时
    Beijing原有1万条轨迹，处理后有540万条训练集，135万测试集
    beijing100400 是训练32维向量
    *************************************************************************
'''
PAD = 0
BOS = 1
...
def set_args(is_train=True):
    ...
    *************************************************************************
    '''
    parser.add_argument("-read_train_num", type=int, default=10000000, help='the number of training data')
    parser.add_argument("-read_val_num", type=int, default=100000, help="the number of validate data")
    ...
    *************************************************************************
    ...
    parser.add_argument("-dis_freq", type=float, default=100, help="三元损失使用频率")
    ...
    # beijing batch=300+ 3090拉满  porto 30+拉满
    parser.add_argument("-batch", type=int, default=300 if city_name == "beijing" else 30, help="The batch size")
